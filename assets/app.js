...
const CONFIG = {
  ...
  /* رابط القاعة على خرائط Google — دبوس مضبوط، يفتح تطبيق الخرائط على الموبايل */
  mapLink: 'https://maps.app.goo.gl/ZZeN1Cjo58YaEwGKA',

  /* إحداثيات الدبوس 'خط العرض,خط الطول' — تجعل الخريطة المدمجة وزر التوجيه
     دقيقين تمامًا بدل البحث بالاسم. خذها من رابط خرائط Google بعد علامة @
     مثل .../@31.0767179,31.158289,18z */
  coords: '',

  /* عبارة البحث الاحتياطية حين لا تتوفّر إحداثيات */
  mapQuery: 'قاعة جردينيا دمرو مركز المحلة الكبرى محافظة الغربية',
...
const RSVP_TEXT =
  `ألف مبروك يا ${CONFIG.host}! 🎉 جايّ فرح ${CONFIG.groom} و ${CONFIG.bride} إن شاء الله\n` +
